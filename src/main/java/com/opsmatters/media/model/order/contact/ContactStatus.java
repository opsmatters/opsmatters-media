...
public enum ContactStatus
{
    ...
    SUSPENDED("Suspended", "glyphicon-exclamation-sign", "status-error"),
     ...
     */
    ContactStatus(String value, String icon, String css)
    {
        this.value = value;
        this.icon = icon;
        this.css = css;
    ...
    {
        ContactStatus[] types = values();
        for(ContactStatus type : types)
        {
    ...
    /**
     * Returns a list of the Contact statuses.
     */
    public static List<ContactStatus> toList()
    {
        List<ContactStatus> ret = new ArrayList<ContactStatus>();
