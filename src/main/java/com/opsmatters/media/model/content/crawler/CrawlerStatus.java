...
/**
 * Represents the status of a content crawler.
 * 
...
public enum CrawlerStatus
{
     ...
     */
    CrawlerStatus(String value, String icon, String css)
    {
        this.value = value;
        this.icon = icon;
        this.css = css;
     ...
     */
    public static CrawlerStatus fromValue(String value)
    {
        CrawlerStatus[] types = values();
        for(CrawlerStatus type : types)
        {
