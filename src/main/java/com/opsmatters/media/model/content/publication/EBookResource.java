...
public class EBookResource extends PublicationResource
{
     ...
     */
    public EBookResource(Site site, String code, PublicationTeaser obj)
    {
        init();
        setSiteId(site.getId());
        setCode(code);
     ...
     */
    public static EBookResource getDefault(Site site, EBookConfig config) throws DateTimeParseException
    {
