...
public enum ImageStatus
{
     ...
     */
    ImageStatus(String value, String icon, String css)
    {
        this.value = value;
        this.icon = icon;
        this.css = css;
    ...
    {
        ImageStatus[] types = values();
        for(ImageStatus type : types)
        {
    ...
    /**
     * Returns a list of the image statuses.
     */
    public static List<ImageStatus> toList()
    {
        List<ImageStatus> ret = new ArrayList<ImageStatus>();
