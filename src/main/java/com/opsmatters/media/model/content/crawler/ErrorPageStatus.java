...
/**
 * Represents the status of an error page.
 * 
...
public enum ErrorPageStatus
{
     ...
     */
    ErrorPageStatus(String value, String icon, String css)
    {
        this.value = value;
        this.icon = icon;
        this.css = css;
     ...
     */
    public static ErrorPageStatus fromValue(String value)
    {
        ErrorPageStatus[] types = values();
        for(ErrorPageStatus type : types)
        {
    ...
    /**
     * Returns a list of the error page statuses.
     */
    public static List<ErrorPageStatus> toList()
    {
        List<ErrorPageStatus> ret = new ArrayList<ErrorPageStatus>();
