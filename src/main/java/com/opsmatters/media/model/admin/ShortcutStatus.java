...
/**
 * Represents the status of a shortcut.
 * 
...
public enum ShortcutStatus
{
     ...
     */
    ShortcutStatus(String value, String icon, String css)
    {
        this.value = value;
        this.icon = icon;
        this.css = css;
     ...
     */
    public static ShortcutStatus fromValue(String value)
    {
        ShortcutStatus[] types = values();
        for(ShortcutStatus type : types)
        {
    ...
    /**
     * Returns a list of the shortcut statuses.
     */
    public static List<ShortcutStatus> toList()
    {
        List<ShortcutStatus> ret = new ArrayList<ShortcutStatus>();
