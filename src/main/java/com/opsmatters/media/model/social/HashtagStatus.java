...
/**
 * Represents the status of a hashtag.
 * 
...
public enum HashtagStatus
{
     ...
     */
    HashtagStatus(String value, String icon, String css)
    {
        this.value = value;
        this.icon = icon;
        this.css = css;
     ...
     */
    public static HashtagStatus fromValue(String value)
    {
        HashtagStatus[] types = values();
        for(HashtagStatus type : types)
        {
    ...
    /**
     * Returns a list of the Hashtag statuses.
     */
    public static List<HashtagStatus> toList()
    {
        List<HashtagStatus> ret = new ArrayList<HashtagStatus>();
