...
/**
 * Represents the status of a social channel.
 * 
...
public enum SocialChannelStatus
{
     ...
     */
    SocialChannelStatus(String value, String icon, String css)
    {
        this.value = value;
        this.icon = icon;
        this.css = css;
     ...
     */
    public static SocialChannelStatus fromValue(String value)
    {
        SocialChannelStatus[] types = values();
        for(SocialChannelStatus type : types)
        {
    ...
    /**
     * Returns a list of the social channel statuses.
     */
    public static List<SocialChannelStatus> toList()
    {
