...
public enum RepoProviderId
{
     ...
     */
    RepoProviderId(String code, String value, String url)
    {
        this.code = code;
        this.value = value;
        this.url = url;
     ...
     */
    public static RepoProviderId fromCode(String code)
    {
        RepoProviderId[] types = values();
        for(RepoProviderId type : types)
        {
     ...
     */
    public static RepoProviderId fromUrl(String url)
    {
        RepoProviderId[] types = values();
        for(RepoProviderId type : types)
        {
