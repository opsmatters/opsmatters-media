 ...
 */
public class JobConfiguration extends ContentConfiguration<JobResource>
{
     ...
     * Copy constructor.
     */
    public JobConfiguration(JobConfiguration obj)
    {
     ...
     */
    public void copyAttributes(JobConfiguration obj)
    {
        if(obj != null)
        {
