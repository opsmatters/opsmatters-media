 ...
 */
public class WhitePaperCrawler extends WebPageCrawler<PublicationTeaser,PublicationDetails>
{
    ...
    /**
     * Create the white paper teaser from the given element.
     */
    @Override
    ...
    /**
     * Create white paper details from the given url.
     */
    ...
    /**
     * Returns the processed white paper derived from the given teaser.
     */
    @Override
