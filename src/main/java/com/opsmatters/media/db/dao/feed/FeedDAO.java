...
/**
 * DAO that provides operations on a feed table in the database.
 * 
 * @author Gerald Curley (opsmatters)
 */
public abstract class FeedDAO<T> extends BaseDAO
{
     ...
     */
    public FeedDAO(DAOFactory factory, String tableName)
    {
