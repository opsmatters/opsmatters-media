...
import com.opsmatters.media.model.content.publication.WhitePaperResource;
...
public class WhitePaperResourceDAO extends ContentDAO<WhitePaperResource>
{
    ...
    private static final String UPDATE_SQL =  
      "UPDATE WHITE_PAPERS SET PUBLISHED_DATE=?, UUID=?, TITLE=?, URL=?, PUBLISHED=?, STATUS=?, ATTRIBUTES=?, SESSION_ID=? "
    ...
    protected void defineTable()
    {
        ...
        table.addIndex("WHITE_PAPERS_SESSION_IDX", new String[] {"SESSION_ID"});
