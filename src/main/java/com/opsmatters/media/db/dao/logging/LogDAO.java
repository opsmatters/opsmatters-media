...
/**
 * DAO that provides operations on a log table in the database.
 * 
 * @author Gerald Curley (opsmatters)
 */
public abstract class LogDAO<T> extends BaseDAO
{
     ...
     */
    public LogDAO(DAOFactory factory, String tableName)
    {
